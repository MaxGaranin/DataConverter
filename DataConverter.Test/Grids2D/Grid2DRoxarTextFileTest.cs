...
{
    [TestFixture]
    public class Grid2DRoxarFileTest
    {
        private const string FILE_IN = @"..\..\data\Surfaces\RoxarText\TopTL";
        private const string FILE_OUT = @"..\..\data\Surfaces\RoxarText\TopTLOut";

        private const string FILE_NOT_NUMBER = @"..\..\data\Surfaces\RoxarText\Bad_NotNumber";
        ...
        {
            new Grid2DRoxarFile().Read(FILE_NOT_NUMBER);
        }
